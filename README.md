...
```javascript
dcumin = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dcumin@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-dcumin/tags). For example,

```javascript
dcumin = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dcumin@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dcumin = require( 'path/to/vendor/umd/stats-strided-dcumin/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dcumin@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-dcumin.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-dcumin

[test-image]: https://github.com/stdlib-js/stats-strided-dcumin/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-strided-dcumin/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-dcumin/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-dcumin?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-dcumin.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-dcumin/main
...
[branches-url]: https://github.com/stdlib-js/stats-strided-dcumin/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-dcumin/main/LICENSE
